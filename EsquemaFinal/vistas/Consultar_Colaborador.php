...
<?php include("../3modelo/autenticacion.php");?>
		<div  align="center" >
				  ...
				  <div><br>
				    <h3>Colaborador</h3><br>
					  
					<form name="form" method="post" action="../2controlador/C_Usuario.php" > 
						 <table align="center">
						  <tr>
						    <td class="registr">Identificación</td>
						    <td class="registr"><input type="text" name="dni_user" title="usuario" value="ingrese identificación" onClick="value=''"></td>
						  </tr>
					 ...
					 <input type="hidden" name="rol_user"  readonly="readonly" value="">
                                         ...
                                         <tr>    
						  <script language="JavaScript">function consultar(){ document.form.txtoperacion.value = 'consultarDatosCol';}</script>    
