            ...
            <form name="form" method="post" action="../2controlador/C_Usuario.php" enctype="multipart/form-data"> 
                <table align="center" >
                    ...
                    <tr>
                        ...
                        <td class="registr"><input type="hidden" name="clasificacion_usuario" title="¿Donde nacio?"  value='<?php echo $clasificacion_usuario; ?>'></td>

<!--  <td class="registr">Fecha acceso:</td> -->
                        <td class="registr"><input type="hidden" name="ultimo_acceso" title="Cuando nacio (AAAA-MM-DD)" value='<?php echo $ultimo_acceso; ?>'></td>
                    </tr>
                    ...
                    <tr><br>
                    <script language="JavaScript">function actualizar() {
                            document.form.txtoperacion.value = 'actualizar';
                        }</script>    
