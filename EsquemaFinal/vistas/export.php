 ...
 $registros = mysql_num_rows ($resultado);
  if ($registros > 0) {
   ...
   while ($registro = mysql_fetch_object ($resultado)) {
      ...
      /*
      SELECT `dni_user`, `tipodni_user`, `nom_user`, `apell_user`, `clave_user`,
              `sex_user`, `mail_user`, `tel_user`, `civil_user`, `lugarnac_user`, 
              `nac_user`, `localidad_user`, `estrato_user`, `barrio_user`, `archivo_usuario`, 
              `responsable_user`, `cel_respon_user`, `foto_user`, `fecha_registro_user`, `"
          . "carrera_user`, `universidad_user`, `id_colegio`, `id_estado`, 
              `id_jornada`, `rol_user`, `id_materia_user` */
