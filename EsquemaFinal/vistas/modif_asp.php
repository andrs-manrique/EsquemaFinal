                        ...
                        <div id="contieneblog">
                            ...
                            <form name="form" method="post" action="../2controlador/C_Usuario.php" enctype="multipart/form-data"> 
                                <table align="center" >
                                    ...
                                    <tr>
                                        <td class="registr">Tipo Clasificacion</td>	
                                        <td class="registr">
                                            <select name="clasificacion_usuario" id="civil_user" readonly="readonly" >
                                                <option value="<?php echo $clasificacion_usuario; ?>"><?php
                                                    ...
                                                    ?></option>
                                                <option value="0">Sin Clasifi</option>
                                                <option value="1">Tipo A</option>
                                                <option value="2">Tipo B</option>
                                                <option value="3">Tipo C</option>
                                            </select>
                                        <td>clave</td>
                                        <td class="registr"><input type="text" name="clave_user" title="clavde de Ingreso" value='<?php echo $clave_user; ?>' ></td>
                                    </tr>      
                                    ...
                                    <input type="hidden" name="ultimo_acceso" title=" Interes"  value='<?php echo $ultimo_acceso; ?>'>
                                    ...
                                    <tr><br>
                                    <script language="JavaScript">function modificarParADMIN() {
                                            document.form.txtoperacion.value = 'modificarParADMIN';
                                        }</script>    
                                    <td colspan="4" align="center" class="registr"> 
                                        <input type="submit" name="Submit" value="Modificar Información" onClick="modificarParADMIN()" >
