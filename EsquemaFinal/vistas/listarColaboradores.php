                            ...
                            <tr class="del<?php echo $id ?>">
                                ...
                                <td width="100">
                                    ...
                                    <a rel="tooltip"  title="Delete" id="<?php echo $id; ?>"  
                                       ...
                                       <?php echo"<a href='Borrar_col.php?dni=$id'>Borrar</a>"; // include('modal_delete_Colabor.php');  ?>
                                    ...
                                    <a rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" 
                                       ...
                                       class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
                                        <?php echo"<a href='Edit_col.php?dni=$id'>Editar</a>"; //include('modal_edit_Colabor.php');  ?>
                                </td>
