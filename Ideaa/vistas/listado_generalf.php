...
$sql = mysql_query("SELECT * from t_usuario where rol_user='3' and clasificacion_usuario='2'") or die(mysql_error()); 
?>
...
-->
  ...
  <table align="center">
    ...
    <tr>
      <td>&nbsp;Grupo de Estudio Aspirantes Clasificacion B</td>
    </tr>
    <tr>
      <td>&nbsp;RED INVESTIGATIVA</td>
    </tr>
    <tr></tr>
</table>
	<div id="footer">
...
<div class="page" style="font-size: 7pt">
    ...
    <table class="change_order_items">
      <tr>
        <td colspan="5"><div align="center"><span class="Estilo53"><strong>LISTADO  GENERAL DE ASPIRATES</strong></span></div></td>
      </tr>
      <tbody>
        <tr>
          <th width="7%">Nº</th>
