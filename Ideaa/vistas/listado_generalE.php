...
$sql = mysql_query("SELECT * from t_usuario where rol_user='3' and clasificacion_usuario='1'") or die(mysql_error()); 
?>
...
-->
  ...
  <table align="center">
    ...
    <tr>
      <td>&nbsp;Grupo de Estudio Aspirantes Clasificacion A</td>
    </tr>
    <tr>
