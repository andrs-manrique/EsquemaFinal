<div id="delete_user<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-body">
        ...
        <div class="alert alert-danger">¿Estas seguro de eliminar este COLABORADOR?
        </div>
            
    </div>		
    <div class="modal-footer">
        <a class="btn btn-danger" href="eliminarPart2.php<?php echo '?id=' . $id; ?>">
            <i class="icon-check"></i>&nbsp;Si</a>
