            ...
            <form name="form" method="post" action="../../2controlador/C_Usuario.php" enctype="multipart/form-data"> 
                <table align="center" >
                    ...
                    <tr>
                        ...
                        <td class="registr"><input type="text" name="dni_user" title="usuario"  value='<?php echo base64_decode($_GET['dni']); ?>' readonly=""></td>
                    ...
                    <tr>
                        <td>Clave</td>
                        <td class="registr">
                            <input type="text" name="clave_user" title="clavde de Ingreso" value='<?php echo $clave_user; ?>'></td>
                    </tr>      
                    ...
                    <tr><br>
                    <script language="JavaScript">function actualizarCol() {
          document.form.txtoperacion.value = 'actualizarCol';
      }</script>    
                    <td colspan="4" align="center" class="registr"> 
                        <input type="submit" name="Submit" value="Modificar Información" onClick="actualizarCol()" >
