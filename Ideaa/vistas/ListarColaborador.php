...
<div aling="center">
    <div class="container">
        <div class="margin-top">
            <div class="row">	
                <div align="left"> <a target="_blank" href="ingresarColaborador.php"> <img src='../img/file_add.png' border='0' alt='Link to this page' width= 25px>Registrar usuario</a> </div>
