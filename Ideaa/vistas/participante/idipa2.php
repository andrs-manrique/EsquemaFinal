            ...
            <table>
                <table align="center" border="0">
                    ...
                    <tr><td class="registr">Documento </td>
                        <td class="registr"><input type="text" name="id_participante"  autocomplete="off" maxlength="11" value="<?php echo $variable; ?>" readonly="readonly"></td>

                    <tr><td class="registr">Observaciones </td>
