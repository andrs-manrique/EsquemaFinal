...
//
    ...
    //---------------------------
     ...
     public function modificarClasificacion() { //                                                                                                                                                                                                                                      usuario_nombre='$this->nombre',usuario_apellido='$this->apellido',usuario_correo='$this->email',
        $consulta = "update t_usuario set clasificacion_usuario='$this->clasificacion_usuario' where(dni_user='$this->dni')";
        if (mysql_query($consulta)) {
            echo"<script language='javascript'> alert('La Clasificacion se ha Actualizado');  </script>";
