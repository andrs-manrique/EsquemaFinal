...
$clasificacion_usuario=$_POST["clasificacion_usuario"];
...
$objUsuario = new usuario(
        ...
        $clasificacion_usuario,$ultimo_acceso);
...
switch ($operacion) {
    ...
    case "modificarParADMIN":
       ...
       case "modificarClasificacion":
             ...
             echo"<script language='javascript'> alert('..Modificando la Clasificacion:..');  </script>";

       	$objUsuario->modificarClasificacion();
        break;
